...
SD_write_data() {
    ...
    if (data_file_main) {
        ...
        data_file_main.print(String(",") + String(set_fan_ON) + String(";") +
                             String(set_fan_OFF));
        data_file_main.print(String(",") + String(set_water_ON) + String(";") +
                             String(set_water_OFF));
        data_file_main.print(String(",") + String(set_light_ON) + String(";") +
                             String(set_light_OFF));
        data_file_main.print(String(",") + String(set_temp_ON) + String(";") +
                             String(set_temp_OFF));
...
co2_control() {
    ...
    // take co2 and temp measurement from MH-Z19B and average it over 10 and 50
    // measurements
